            ...
            <section className="flex flex-col h-screen lg:justify-end font-poppins">
                        ...
                        <div className="max-w-6xl mx-auto">
                              <div className="justify-center flex-1 max-w-6xl px-4 py-2 mx-auto lg:py-0">
                                    <div className="flex flex-wrap py-4 -mx-3">
                                          <div className="w-full px-4 mb-7 md:w-1/2 lg:w-4/12 lg:mb-0">
                                                ...
                                                <div className="w-16 mb-4 border-b-2 border-amber-600 dark:border-gray-600" />
                                                <p className="text-base font-normal leading-6 lg:w-64 dark:text-gray-400">
                                                We understand that finding the perfect accommodation can be a daunting task, which is why we're here to make your journey easier and more enjoyable.
                                                </p>
                                          </div>
                                          ...
                                          <div className="w-full px-4 mb-7 lg:mb-0 md:w-1/4 lg:w-2/12">
                                                ...
                                                <div className="w-16 mb-4 border-b-2 border-amber-600 dark:border-gray-600"></div>
                                                <ul>
                                                      <li className="mb-4">
                                                            <Link to='/'>
                                                            Home
                              ...
                              <div className="flex flex-wrap items-center justify-between px-4 mb-4">
                                    <h2 className="mb-4 text-2xl font-semibold tracking-wider text-gray-700 lg:mb-0 dark:text-gray-400">
                                          Subscribe to the latest Room offer 
                                    </h2>
                  ...
                  <div className="px-4 py-6 bg-gray-300 dark:bg-gray-800 dark:text-gray-400">
                        <div className="flex flex-wrap items-center justify-between max-w-6xl gap-4 mx-auto">
                              <div className=""> © Copyright 2022 . All Rights Reserved || Booking Hotels</div>
