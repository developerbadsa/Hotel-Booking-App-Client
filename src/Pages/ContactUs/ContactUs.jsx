                              ...
                              <div className="flex flex-wrap mb-6">
                                    <div className="w-full px-4 mb-20 lg:w-1/3 lg:mb-0">
                                          <div className="relative h-full px-6 pt-20 pb-12 text-center shadow bg-gray-50 dark:bg-gray-900">
                                                <div className="absolute top-0 inline-flex items-center justify-center w-20 h-20 text-yellow-600 transform -translate-x-1/2 -translate-y-1/2 bg-yellow-100 border border-yellow-600 rounded-full dark:text-gray-400 dark:border-gray-700 dark:bg-gray-700 left-1/2 ">
                                                      <svg
