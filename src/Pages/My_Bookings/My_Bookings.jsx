      ...
      const {
            ...
            queryFn: async () => {
                  const data = await fetch(
                        `https://hotel-booking-app-server-wi7a.vercel.app/my_bookings/?email=${user.email}`,
                        { credentials: 'include' }
                  );
                                                ...
                                                <tbody>
                                                      {bookings?.map((booking, index) => {
                                                            ...
                                                            const handleBookCancel = () => {
                                                                  ...
                                                                  Swal.fire({
                                                                        ...
                                                                        if (result.isConfirmed) {
                                                                              axios
                                                                                    .delete(
                                                                                          `https://hotel-booking-app-server-wi7a.vercel.app/my_bookings/delete/?deleteBook=${_id}&email=${user.email}&title=${RoomTitle}`
                                                                                    )
                                                                                    .then(() => {
                                                                                          refetch();
                                                                                    })
                                                            ...
                                                            const submitReview = () => {
                                                                  ...
                                                                  axios.post(`https://hotel-booking-app-server-wi7a.vercel.app/room_review?title=${RoomTitle}`, { reviewdata })
                                                                        .then(res => {
                                                                              Swal.fire({
                                                                                    title: "Review added",
                                                                                    icon: "success"
